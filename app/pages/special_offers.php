...
<meta charset="UTF-8">
    ...
    <link rel="stylesheet" href="../css/stock-media.css">
        ...
        <div class = "wrap-main">
            ...
            <div href="#" class = "wrap-card">
                ...
                <span class="card__content">
                    ...
                    <p class = "content-text">
                    С воскресенья по четверг в нашем баре проходит замечательная акция! 
                    Скидка 25% на бар, кроме пива.У нас имеется множество коктелей, 
                    шотов и много другой вкусной выпивки, приходите и попробуйте!</p>
                </span>
            </div>
            <div href="#" class = "wrap-card">
                ...
                <span class="card__content">
                    ...
                    <p class = "content-text">
                    С воскресенья по четверг в нашем баре проходит замечательная акция!
                    Скидка 25% на кальян. В нашем меню представлено несколько видов кальяна.
                    Попробуйте и насладитесь незабываемым вкусом.</p>
                </span>
            </div>
            <div href="#" class = "wrap-card">
                ...
                <span class="card__content">
                    ...
                    <p class = "content-text">
                    В нашем баре проходит замечательная акция!
                    Если вы закажите 4 шота ягерместера то пятый шот получите в подарок. 
                    Неплохо, правда?</p>
                </span>
            </div>
            <div href="#" class = "wrap-card">
                ...
                <span class="card__content">
                    ...
                    <p class = "content-text">
                    В нашем баре проходит замечательная акция!
                    Если вы закажите бутылку вина, то совершенно бесплатно вам достанется сырное ассорти,
                    которое замечательно подходит к вину. В нашем баре довольно большой выбор вина, 
                    загляните в пункт меню.</p>
                </span>
            </div>
        </div>
    </main>
